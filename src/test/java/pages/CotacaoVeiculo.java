...
public class CotacaoVeiculo {
	...
	public void enviarCotacao() throws IOException {
		metodos.preencher(elemento.getEmail(), "juan.soares@accenture.com", "preenche o e-mail");
		metodos.preencher(elemento.getPhone(), "11901234567", "preenche o telefone");
		metodos.preencher(elemento.getUsername(), "Juan", "preenche o nome");
